...
<head>
  ...
  <title>AgriBuzz - Agriculture Management System</title>
  ...
  <meta content="Agriculture Management System, AgriBuzz" name="keywords">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>AGRIBUZZ</span></a></h1>
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li class="<?php
                            if(basename($_SERVER['PHP_SELF']) == "displaynews.php" )
                            {
                              echo ' active ';
                            }
                            ?>"><a href="displaynews.php?articletype=News">News</a></li>
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li><a href="viewcstpurchasereport.php">Farmer's Kit Purchase Report</a></li>					
