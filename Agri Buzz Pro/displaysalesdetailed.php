...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
		Request Date<font color="#FF0000">*</font> <font color="#FF0000">  (in <?php echo $rs[quantity_type]; ?> ) </font>
		<input type="date" name="requestdate" id="requestdate" readonly value="<?php echo date("Y-m-d"); ?>" class="form-control">
	</div>
	
	<div class="col-md-6 form-group">
		Expiry Date<font color="#FF0000">*</font> <font color="#FF0000">  (in <?php echo $rs[quantity_type]; ?> ) </font>
